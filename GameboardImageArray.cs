...
namespace GameboardGUI
{
    public class GameboardImageArray : UserControl
    {
        ...
        /// <param name="topLeftCorner">A point object with X and Y values representing the distance between the top-left corner of the gameboard 
        /// and the top (Y) and left (X) edges of its containing form, parentForm.</param>
        /// <param name="bottomRightCorner">A point object with X and Y values representing the distance between the bottom-right corner of the 
        /// gameboard and the bottom (Y) and right (X) edges of its containing form, parentForm.</param>
        /// <param name="tileMargin">The gap between each image, e.g., Top, Left, Right and Bottom margins</param>
        /// <param name="tileImagePath">The path to the folder containing the images rendered in the PictureBox array of the gameboard</param>
        /// <exception cref="GameboardImageArraySizeException"></exception>
